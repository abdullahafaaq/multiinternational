...
export default function AdminServicesPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-serif text-3xl font-bold text-foreground mb-2">Services Page</h1>
        <p className="text-muted-foreground">Manage services content for the Services page and homepage.</p>
      </div>
      ...
      <Tabs defaultValue="services" className="w-full">
        ...
        <TabsContent value="services" className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-muted-foreground">Featured services will appear on the homepage.</p>
            </div>
        ...
        <TabsContent value="hero" className="space-y-6">
          <Card>
            <CardHeader>
              <CardTitle className="font-serif">Services Page Hero</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-sm text-muted-foreground">
                The hero section for the Services page uses a default design. Hero content is configured in the Homepage section.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
